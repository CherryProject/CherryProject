...
;(function(window) {
	...
	function Calendar(el) {
		...
		this.calendarDays.forEach(function(d, pos) {
			...
			if( content !== undefined ) {
				var contentTitle = contents[pos].querySelector('.other_card_content__title');
	...
	Calendar.prototype._showContent = function(day) {
		...
		var content = contents[this.currentDayIdx],
			title = content.querySelector('.other_card_content__title'),
			description = content.querySelector('.other_card_content__description'),
			meta = content.querySelector('.other_card_content__meta');

		content.classList.add('other_card_content__block--current');
	...
	Calendar.prototype._hideContent = function() {
		...
		day.titlefx.hide(day.titlefxSettings, function() {
			content.classList.remove('other_card_content__block--current');
		});
	};
	...
	var calendarEl = document.querySelector('.calendar'),
		...
		colortimeout,
		contentEl = document.querySelector('.other_card_content'),
		contents = contentEl.querySelectorAll('.other_card_content__block'),
		backCtrl = contentEl.querySelector('.btn-back'),
		contentNumber = contentEl.querySelector('.other_card_content__number'),
